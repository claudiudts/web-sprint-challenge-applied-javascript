...
1. What is the DOM?
   1. it is a data structure in known as the 'Tree', because parent elements have nested children elements (or leaves).

2. What is an event?
   1. every user interaction with a site is an event.

3. What is an event listener?
   1. for a event to happen there must be a specific listener, like a click or key press

4. Why would we convert a NodeList into an Array?
   1. so we can use proper iteration of arrays. 

5. What is a component?
   1. Components are reusable pieces of code that can be used to build elements sharing functionality and styling.
